...
interface
uses
  Windows, Winspool, SysUtils, StdCtrls, ExtCtrls, Forms, Graphics, IniFiles, Grids, DBGrids;
...
procedure PrintLabelVar(PrinterName, Line1, Line2, Line3, Line4, Count, SampNr, L1L1, L1L2, L1L3, L1L4, L1bc,
  L2L1, L2L2, L2L3, L2L4, L2bc: string; DoBarcode: boolean);
...
var
  ...
  begin
    Result := #$0D + #$0A + '1X1100000450145l01030001' + #$0D + #$0A; //dicke Linie; 1X11000: fixed for Lines, 0045:X, 0144:Y, l01:size, 030:horiz. ausdehn., 001:vertikale ausd
  end;

  function BarcodeVarHeader: string;
  begin
    Result := #$0D + #$0A + '1W1c33000'; //DataMatrix: Modulbreite 3
